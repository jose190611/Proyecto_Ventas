...
IF NOT EXISTS(SELECT * FROM sys.procedures WHERE name = 'SP_Insertar_Tiendas')
PRINT 'Creando proceso';
ELSE
BEGIN
DROP PROCEDURE SP_Insertar_Tiendas;
END
GO

GO
CREATE PROCEDURE SP_Insertar_Tiendas 
@Usuario VARCHAR(MAX),
@Nombre VARCHAR(Max),
...
BEGIN CATCH
	...
	EXEC SP_Msg 'Ha ocurrido un error en SP_Insertar_Tiendas';
...
IF NOT EXISTS(SELECT * FROM sys.procedures WHERE name = 'SP_Eliminar_Tiendas')
PRINT 'Creando proceso';
ELSE
BEGIN
DROP PROCEDURE SP_Eliminar_Tiendas;
END
GO

GO
CREATE PROCEDURE SP_Eliminar_Tiendas 
@Usuario VARCHAR(MAX),
@ClaTien VARCHAR(MAX),
@Nombre VARCHAR(MAX),
@Salida VARCHAR(MAX) OUTPUT
...
BEGIN CATCH
	ROLLBACK TRANSACTION
	EXEC SP_Msg 'Ha ocurrido un error en SP_Eliminar_Tiendas';
...
IF NOT EXISTS(SELECT * FROM sys.procedures WHERE name = 'SP_Editar_Tiendas')
PRINT 'Creando proceso SP_Editar_Tiendas';
ELSE
BEGIN
DROP PROCEDURE SP_Editar_Tiendas;
END
GO
